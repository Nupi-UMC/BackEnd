...
public class KakaoNaviService {
    ...
    private static final String KAKAO_API_KEY = "f9118a93878a61889a2f9bd67ef75c2f";
    ...
    public String getOptimalRoute(String origin, String destination, String waypoints) {
        try {
            // JSON 요청 본문 구성
            ...
            if (waypoints != null && !waypoints.isEmpty()) {
                requestBody.put("waypoints", objectMapper.readValue(waypoints, Object.class));
            }
